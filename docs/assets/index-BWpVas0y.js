import{j as e,m as v}from"./motion-D88nQ0J8.js";import{a as $,R as k,u as P,r as x,L as d,N as L,b as w,c as b,B as W,d as F,e as m}from"./react-CpPsYu-k.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const l of i)if(l.type==="childList")for(const h of l.addedNodes)h.tagName==="LINK"&&h.rel==="modulepreload"&&r(h)}).observe(document,{childList:!0,subtree:!0});function t(i){const l={};return i.integrity&&(l.integrity=i.integrity),i.referrerPolicy&&(l.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?l.credentials="include":i.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function r(i){if(i.ep)return;i.ep=!0;const l=t(i);fetch(i.href,l)}})();var C,_=$;C=_.createRoot,_.hydrateRoot;const y={},I=k.createContext(y);function p(s){const n=k.useContext(I);return k.useMemo(function(){return typeof s=="function"?s(n):{...n,...s}},[n,s])}function q(s){let n;return s.disableParentContext?n=typeof s.components=="function"?s.components(y):s.components||y:n=p(s.components),k.createElement(I.Provider,{value:n},s.children)}function V(){const{pathname:s,hash:n}=P();return x.useEffect(()=>{if(n){const t=document.querySelector(n);if(t){t.scrollIntoView({behavior:"smooth"});return}}window.scrollTo(0,0)},[s,n]),null}function c({children:s,size:n="default",className:t=""}){const r={narrow:"max-w-2xl",default:"max-w-5xl",wide:"max-w-6xl"};return e.jsx("div",{className:`mx-auto px-6 sm:px-8 ${r[n]} ${t}`,children:s})}/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const H=x.forwardRef(({color:s="currentColor",size:n=24,strokeWidth:t=2,absoluteStrokeWidth:r,className:i="",children:l,iconNode:h,...u},R)=>x.createElement("svg",{ref:R,...J,width:n,height:n,stroke:s,strokeWidth:r?Number(t)*24/Number(n):t,className:E("lucide",i),...u},[...h.map(([B,z])=>x.createElement(B,z)),...Array.isArray(l)?l:[l]]));/**
 * @license lucide-react v0.408.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const j=(s,n)=>{const t=x.forwardRef(({className:r,...i},l)=>x.createElement(H,{ref:l,iconNode:n,className:E(`lucide-${X(s)}`,r),...i}));return t.displayName=`${s}`,t};/**
 * @license lucide-react v0.408.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
`]})]})}function xe(s={}){const{wrapper:n}={...p(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(D,{...s})}):D(s)}const oe=Object.freeze(Object.defineProperty({__proto__:null,default:xe,frontmatter:he},Symbol.toStringTag,{value:"Module"})),ae={title:"Remote Sensing Benchmark",slug:"remote-sensing-benchmark",date:"2026-08-24",tags:["remote sensing","benchmark","AI evaluation"],summary:"关于如何从真实职业任务和专业交付物出发，设计端到端遥感 AI Benchmark的一些思考",featured:!0};function T(s){const n={a:"a",blockquote:"blockquote",br:"br",code:"code",h2:"h2",h3:"h3",h4:"h4",h5:"h5",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...p(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"1. 概述"}),`
