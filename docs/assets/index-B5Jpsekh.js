import{j as e,m as v}from"./motion-D88nQ0J8.js";import{a as z,R as k,u as M,r as h,L as d,N as L,b as w,c as b,B as W,d as F,e as m}from"./react-CpPsYu-k.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const l of i)if(l.type==="childList")for(const x of l.addedNodes)x.tagName==="LINK"&&x.rel==="modulepreload"&&r(x)}).observe(document,{childList:!0,subtree:!0});function t(i){const l={};return i.integrity&&(l.integrity=i.integrity),i.referrerPolicy&&(l.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?l.credentials="include":i.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function r(i){if(i.ep)return;i.ep=!0;const l=t(i);fetch(i.href,l)}})();var C,_=z;C=_.createRoot,_.hydrateRoot;const y={},I=k.createContext(y);function p(s){const n=k.useContext(I);return k.useMemo(function(){return typeof s=="function"?s(n):{...n,...s}},[n,s])}function q(s){let n;return s.disableParentContext?n=typeof s.components=="function"?s.components(y):s.components||y:n=p(s.components),k.createElement(I.Provider,{value:n},s.children)}function V(){const{pathname:s,hash:n}=M();return h.useEffect(()=>{if(n){const t=document.querySelector(n);if(t){t.scrollIntoView({behavior:"smooth"});return}}window.scrollTo(0,0)},[s,n]),null}function c({children:s,size:n="default",className:t=""}){const r={narrow:"max-w-2xl",default:"max-w-5xl",wide:"max-w-6xl"};return e.jsx("div",{className:`mx-auto px-6 sm:px-8 ${r[n]} ${t}`,children:s})}/**
...
`]})]})}function je(s={}){const{wrapper:n}={...p(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(T,{...s})}):T(s)}const me=Object.freeze(Object.defineProperty({__proto__:null,default:je,frontmatter:ae},Symbol.toStringTag,{value:"Module"})),ge={slug:"about",title:"About"};function P(s){const n={a:"a",h2:"h2",p:"p",strong:"strong",...p(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.p,{children:"I write notes and build tools. Writing things down is the best way for me to rethink them."}),`
