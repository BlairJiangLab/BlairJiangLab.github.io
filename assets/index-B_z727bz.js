...
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"previous_topographic_map.gpkg"}),"（上一期1:2000地形图，包含建筑物、道路、水系和高程点等图层及原始要素ID）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"latest_orthophoto.tif"}),"（项目区最新无人机正射影像，用于判读地物新增、拆除和位置变化）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"gnss_survey_points.xlsx"}),"（补充GNSS测量点，包含点号、平面坐标、高程、采集时间和要素代码）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"feature_code_dictionary.xlsx"}),"（地形要素编码、图层归属、属性名称和允许值对照表）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"mapping_specification.pdf"}),"（项目测图规范，规定坐标系、精度、拓扑、制图和交付要求）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"project_boundary.gpkg"}),"（本次更新工作的项目范围边界）"]}),`
`]}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"要求交付"})}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"updated_topographic_map.gpkg"}),"（更新后的地形图数据库，保留规定图层、属性结构和原始要素ID）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"survey_data_issues.xlsx"}),"（重复点、坐标异常、高程异常及其他测量数据问题清单）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"topographic_map.pdf"}),"（用于检查和汇报的1:2000地形图版面成果）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"update_log.docx"}),"（逐项记录新增、删除、修改内容及其数据来源和判断依据）"]}),`
`]}),`
...
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"参考文件"})}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"sentinel1_pre_event.tif"}),"（灾前Sentinel-1 SAR影像，作为正常地表后向散射基准）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"sentinel1_post_event.tif"}),"（灾后Sentinel-1 SAR影像，用于识别新增低后向散射及变化区域）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"permanent_water.gpkg"}),"（河流、湖泊等常年水体范围，用于从结果中排除永久水面）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"county_boundaries.gpkg"}),"（三个县的行政边界及县名、县代码，用于分区统计）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"buildings.gpkg"}),"（研究区建筑物轮廓，用于统计受影响建筑物数量）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"roads.gpkg"}),"（道路中心线及道路等级，用于计算受影响道路长度）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"validation_points.csv"}),"（已判定为洪水或非洪水的验证样点及坐标，用于独立精度评价）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"data_description.pdf"}),"（数据日期、极化方式、分辨率、坐标系、字段及使用限制说明）"]}),`
`]}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"要求交付"})}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"flood_extent.tif"}),"（新增洪水范围栅格，按规定编码洪水、非洪水和NoData）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"flood_extent.gpkg"}),"（新增洪水范围矢量，包含县代码、面积和必要的质量字段）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"impact_statistics.xlsx"}),"（分县汇总淹没面积、受影响建筑物数量和道路长度）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"methodology.docx"}),"（说明预处理、洪水提取、阈值、后处理、验证和不确定性）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"emergency_briefing.pdf"}),"（面向应急管理人员的简报，展示重点受灾区域和主要统计结果）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"analysis_script.py"}),"（可复现主要洪水提取和影响统计过程的分析脚本）"]}),`
`]}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"关键Rubric"})}),`
`,e.jsxs(n.ul,{children:[`
...
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"参考文件"})}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"submitted_dom.tif"}),"（外包单位提交的数字正射影像成果，用于平面精度与影像质量检查）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"submitted_dsm.tif"}),"（外包单位提交的数字表面模型，用于高程精度和异常检查）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"control_points.xlsx"}),"（空中三角测量使用的像控点坐标及点位信息，仅用于核查控制条件）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"independent_checkpoints.xlsx"}),"（未参与空三解算的独立检查点，用于计算平面和高程RMSE）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"aerial_triangulation_report.pdf"}),"（外包单位提交的空三处理过程、参数和精度报告）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"project_boundary.gpkg"}),"（验收项目的有效空间范围）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"acceptance_standard.pdf"}),"（1:2000成果精度、完整性、缺陷等级和验收判定标准）"]}),`
`]}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"要求交付"})}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"accuracy_calculation.xlsx"}),"（检查点误差、平面RMSE、高程RMSE及限差判定计算表）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"photogrammetry_defects.gpkg"}),"（缺陷点或图斑，记录缺陷类型、严重程度和处理建议）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"acceptance_map.pdf"}),"（展示项目范围、检查点和缺陷空间分布的验收地图）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"quality_inspection_report.docx"}),"（汇总精度计算、质量问题、合格性结论和返工建议的质检报告）"]}),`
`]}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"关键Rubric"})}),`
`,e.jsxs(n.ul,{children:[`
...
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"参考文件"})}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"dem.tif"}),"（数字高程模型，用于计算地形坡度）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"land_use.gpkg"}),"（土地利用图层，用于筛选允许建设的用地类型）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"major_roads.gpkg"}),"（主干道路中心线，用于计算候选地的道路可达距离）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"population_grid.tif"}),"（栅格化人口数据，用于估算各候选地可覆盖的人口）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"flood_risk.gpkg"}),"（洪水高风险区，属于选址硬性排除范围）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"protected_areas.gpkg"}),"（自然保护区等限制建设区域，属于硬性排除范围）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"water_bodies.gpkg"}),"（河流、湖泊等水体，用于建立500米避让缓冲区）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"study_area.gpkg"}),"（仓库选址分析的研究区边界）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"site_selection_rules.pdf"}),"（坡度、距离、面积、排除条件和候选地排序规则）"]}),`
`]}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"要求交付"})}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"eligible_sites.gpkg"}),"（满足全部硬约束的连续候选区域及其指标属性）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"site_ranking.xlsx"}),"（候选地面积、道路距离、覆盖人口、风险指标和综合排名表）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"recommended_sites_map.pdf"}),"（展示约束条件、全部合格区域和前三名推荐地的专题地图）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"workflow.py"}),"（可在给定数据上复现筛选、统计和排序过程的GIS脚本）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"method_note.docx"}),"（说明数据处理、约束条件、排序方法、推荐理由和局限性）"]}),`
`]}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"关键Rubric"})}),`
`,e.jsxs(n.ul,{children:[`
...
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"参考文件"})}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"scene_01.tif"}),"至",e.jsx(n.code,{children:"scene_06.tif"}),"（六景待处理光学卫星影像，可能存在投影、波段、NoData或配准差异）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"scene_metadata.xlsx"}),"（各景影像的产品ID、获取日期、传感器、波段、分辨率和投影信息）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"project_boundary.gpkg"}),"（最终标准化影像需要覆盖和裁剪的项目范围）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"reference_image.tif"}),"（已验证位置精度的参考影像，用于配准和误差检查）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"production_specification.pdf"}),"（投影、分辨率、数据类型、NoData、配准精度和质量检查要求）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"expected_band_schema.xlsx"}),"（目标波段顺序、波段名称、数据类型和允许值范围）"]}),`
`]}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"要求交付"})}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"standardized_mosaic.tif"}),"（完成投影统一、配准、镶嵌和裁剪的标准化多波段影像）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"scene_processing_log.xlsx"}),"（逐景记录输入状态、处理步骤、参数、异常及处理决定）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"quality_control.xlsx"}),"（输出范围、波段、分辨率、NoData、配准误差和覆盖完整性检查表）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"processing_script.py"}),"（可复现主要影像标准化与镶嵌步骤的处理脚本）"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"production_report.docx"}),"（汇总生产过程、最终成果质量、异常影像和使用限制的报告）"]}),`
`]}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"关键Rubric"})}),`
`,e.jsxs(n.ul,{children:[`
